...
// default version: do not keep working residuals
...
// tlpreg version: keep working residuals
...
//                 for (int i = 0; i < *n; ++i)
//                     r_b[k * (*n) + i] += X[j * (*n) + i] * (b_curr[j] - b[idx + j]);
//             }
