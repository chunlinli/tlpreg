...
tlpreg1 <- function(y, X, b.init=NULL, tau=0.5*sqrt(log(p)/n), K=NULL, pen.fac=rep(1,ncol(X)), tol=1e-4, dc.maxit=20, cd.maxit=1e+4) {
    ...
    .Call('tlpreg_c', y, X, b0, br, r, xtx, n, p, tau, K, nK, gamma, ngamma, pen.fac, tol, as.integer(dc.maxit), as.integer(cd.maxit))
