...
SEXP tlpreg_r(SEXP X, SEXP b0, SEXP b, SEXP r,
           ...
           SEXP pen_fac, SEXP tol, SEXP dc_maxit, SEXP cd_maxit)
{
    ...
    tlpreg0(X_ptr, b0_ptr, b_ptr, r_ptr, xtx_ptr, n_ptr, p_ptr, tau_ptr, gamma_ptr, ngamma_ptr, pen_fac_ptr, tol_ptr, dc_maxit_ptr, cd_maxit_ptr);
